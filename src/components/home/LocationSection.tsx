        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-surface-600">{locale === 'pt' ? 'Seg – Dom' : 'Mon – Sun'}</span>
            ...
            <div>
              ...
              <a href="tel:+351928380478" className="text-black font-semibold hover:text-gold transition-colors text-lg">
                +351 928 380 478
              </a>
              <a
                href="tel:+351928380478"
                className="mt-3 flex sm:hidden items-center justify-center gap-2 px-6 py-4 border-2 border-black text-black font-semibold rounded transition-colors w-full active:bg-black active:text-white"
              >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-6 py-4 bg-black text-white font-semibold rounded hover:bg-surface-800 transition-colors duration-200 w-full sm:w-auto"
            >
